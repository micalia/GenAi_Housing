...
// IWYU pragma: private, include "RuntimeTransformer.h"
...
#define CURRENT_FILE_ID FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_RuntimeTransformer_Source_RuntimeTransformer_Public_RuntimeTransformer_h
...
template<> struct TIsUEnumClass<ETransformationType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ESpaceType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ETransformationDomain> { enum { Value = true }; };
