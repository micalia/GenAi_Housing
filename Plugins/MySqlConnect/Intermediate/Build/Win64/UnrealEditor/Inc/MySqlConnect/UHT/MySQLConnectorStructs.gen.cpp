...
template<> MYSQLCONNECT_API UScriptStruct* StaticStruct<FMySQLConnectorTable>()
{
	...
	struct Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLConnectorStructs_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLConnectorStructs_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLConnectorStructs_h_3104861075(TEXT("/Script/MySqlConnect"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLConnectorStructs_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLConnectorStructs_h_Statics::ScriptStructInfo),
		nullptr, 0);
