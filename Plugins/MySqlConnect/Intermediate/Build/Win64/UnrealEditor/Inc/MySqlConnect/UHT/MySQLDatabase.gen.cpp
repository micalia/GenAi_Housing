...
#include "MySqlConnect/Public/MySQLDatabase.h"
...
// Cross Module References
	...
	MYSQLCONNECT_API UClass* Z_Construct_UClass_UMySQLConnection_NoRegister();
	MYSQLCONNECT_API UClass* Z_Construct_UClass_UMySQLDatabase();
	MYSQLCONNECT_API UClass* Z_Construct_UClass_UMySQLDatabase_NoRegister();
	MYSQLCONNECT_API UScriptStruct* Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct();
	MYSQLCONNECT_API UScriptStruct* Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult();
	MYSQLCONNECT_API UScriptStruct* Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair();
	MYSQLCONNECT_API UScriptStruct* Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow();
...
// End Cross Module References
	static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct;
class UScriptStruct* FMySQLConnectorConnectionStruct::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct, (UObject*)Z_Construct_UPackage__Script_MySqlConnect(), TEXT("MySQLConnectorConnectionStruct"));
	}
	return Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct.OuterSingleton;
}
template<> MYSQLCONNECT_API UScriptStruct* StaticStruct<FMySQLConnectorConnectionStruct>()
{
	return FMySQLConnectorConnectionStruct::StaticStruct();
}
	struct Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_conn_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_conn;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UECodeGen_Private::FStructParams ReturnStructParams;
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/MySQLDatabase.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FMySQLConnectorConnectionStruct>();
	}
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewProp_conn_MetaData[] = {
		{ "Category", "MySQLConnector Database Reference" },
		{ "Comment", "/** The database name (not the filename) */" },
		{ "ModuleRelativePath", "Public/MySQLDatabase.h" },
		{ "ToolTip", "The database name (not the filename)" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewProp_conn = { "conn", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMySQLConnectorConnectionStruct, conn), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewProp_conn_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewProp_conn_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewProp_conn,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_MySqlConnect,
		nullptr,
		&NewStructOps,
		"MySQLConnectorConnectionStruct",
		sizeof(FMySQLConnectorConnectionStruct),
		alignof(FMySQLConnectorConnectionStruct),
		Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct()
	{
		if (!Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct.InnerSingleton)
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct.InnerSingleton, Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct.InnerSingleton;
	}
...
class UScriptStruct* FMySQLConnectorKeyValuePair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MySQLConnectorKeyValuePair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair, (UObject*)Z_Construct_UPackage__Script_MySqlConnect(), TEXT("MySQLConnectorKeyValuePair"));
	}
	return Z_Registration_Info_UScriptStruct_MySQLConnectorKeyValuePair.OuterSingleton;
}
template<> MYSQLCONNECT_API UScriptStruct* StaticStruct<FMySQLConnectorKeyValuePair>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMySQLConnectorKeyValuePair, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair_Statics::NewProp_Value_MetaData)) };
...
class UScriptStruct* FMySQLConnectorQueryResultRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MySQLConnectorQueryResultRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow, (UObject*)Z_Construct_UPackage__Script_MySqlConnect(), TEXT("MySQLConnectorQueryResultRow"));
	}
	return Z_Registration_Info_UScriptStruct_MySQLConnectorQueryResultRow.OuterSingleton;
}
template<> MYSQLCONNECT_API UScriptStruct* StaticStruct<FMySQLConnectorQueryResultRow>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow_Statics::NewProp_Fields_Inner = { "Fields", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair, METADATA_PARAMS(nullptr, 0) }; // 3667479316
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow_Statics::NewProp_Fields_MetaData[] = {
		{ "Category", "MySQLConnector Query Result" },
		{ "Comment", "/** A list of field name, field value pairs */" },
		{ "ModuleRelativePath", "Public/MySQLDatabase.h" },
		{ "ToolTip", "A list of field name, field value pairs" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow_Statics::NewProp_Fields = { "Fields", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMySQLConnectorQueryResultRow, Fields), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow_Statics::NewProp_Fields_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow_Statics::NewProp_Fields_MetaData)) }; // 3667479316
...
class UScriptStruct* FMySQLConnectoreQueryResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MySQLConnectoreQueryResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult, (UObject*)Z_Construct_UPackage__Script_MySqlConnect(), TEXT("MySQLConnectoreQueryResult"));
	}
	return Z_Registration_Info_UScriptStruct_MySQLConnectoreQueryResult.OuterSingleton;
}
template<> MYSQLCONNECT_API UScriptStruct* StaticStruct<FMySQLConnectoreQueryResult>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult_Statics::NewProp_ResultRows_Inner = { "ResultRows", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow, METADATA_PARAMS(nullptr, 0) }; // 1138700082
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult_Statics::NewProp_ResultRows = { "ResultRows", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMySQLConnectoreQueryResult, ResultRows), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult_Statics::NewProp_ResultRows_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult_Statics::NewProp_ResultRows_MetaData)) }; // 1138700082
#if WITH_METADATA
	...
	DEFINE_FUNCTION(UMySQLDatabase::execMySQLInitConnection)
	{
		...
		P_GET_PROPERTY(FIntProperty,Z_Param_ConnectionTimeout);
		P_GET_PROPERTY(FIntProperty,Z_Param_ReadTimeout);
		P_GET_PROPERTY(FIntProperty,Z_Param_WriteTimeout);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UMySQLConnection**)Z_Param__Result=UMySQLDatabase::MySQLInitConnection(Z_Param_Host,Z_Param_UserName,Z_Param_UserPassword,Z_Param_DatabaseName,Z_Param_ConnectionTimeout,Z_Param_ReadTimeout,Z_Param_WriteTimeout);
		P_NATIVE_END;
	}
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_TableName = { "TableName", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventCreateTable_Parms, TableName), METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_TableName_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_TableName_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_Fields = { "Fields", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventCreateTable_Parms, Fields), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_Fields_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_Fields_MetaData)) }; // 843490701
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventCreateTable_Parms, Connection), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMySQLDatabase_CreateTable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventCreateTable_Parms, ReturnValue), Z_Construct_UScriptStruct_FMySQLConnectorTable, METADATA_PARAMS(nullptr, 0) }; // 3653337485
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_DropTable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventDropTable_Parms), &Z_Construct_UFunction_UMySQLDatabase_DropTable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorExecuteQuery_Statics::NewProp_Query = { "Query", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorExecuteQuery_Parms, Query), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorExecuteQuery_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorExecuteQuery_Parms, Connection), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorExecuteQuery_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventMySQLConnectorExecuteQuery_Parms), &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorExecuteQuery_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetData_Statics::NewProp_Query = { "Query", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorGetData_Parms, Query), METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetData_Statics::NewProp_Query_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetData_Statics::NewProp_Query_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetData_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorGetData_Parms, Connection), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorGetData_Parms, ReturnValue), Z_Construct_UScriptStruct_FMySQLConnectoreQueryResult, METADATA_PARAMS(nullptr, 0) }; // 4229074062
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP_Statics::NewProp_IP = { "IP", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorGetPlayerControllerIP_Parms, IP), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP_Statics::NewProp_IP_int = { "IP_int", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorGetPlayerControllerIP_Parms, IP_int), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP_Statics::NewProp_PlayerController = { "PlayerController", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorGetPlayerControllerIP_Parms, PlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventMySQLConnectorGetPlayerControllerIP_Parms), &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP_Statics::Function_MetaDataParams[] = {
		{ "Category", "MySQLConnector|Connection" },
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest_Statics::NewProp_Query = { "Query", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorInsertTest_Parms, Query), METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest_Statics::NewProp_Query_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest_Statics::NewProp_Query_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorInsertTest_Parms, Connection), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventMySQLConnectorInsertTest_Parms), &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_FieldName = { "FieldName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorINT_Parms, FieldName), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_PK = { "PK", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventMySQLConnectorINT_Parms), &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_PK_SetBit, METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_PK_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_PK_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_AI = { "AI", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventMySQLConnectorINT_Parms), &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_AI_SetBit, METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_AI_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_AI_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorINT_Parms, ReturnValue), Z_Construct_UScriptStruct_FMySQLConnectorTableField, METADATA_PARAMS(nullptr, 0) }; // 843490701
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT_Statics::Function_MetaDataParams[] = {
		{ "Category", "MySQLConnector|Query|DataTypes" },
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorVARCHAR_Statics::NewProp_FieldLength = { "FieldLength", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorVARCHAR_Parms, FieldLength), METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorVARCHAR_Statics::NewProp_FieldLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorVARCHAR_Statics::NewProp_FieldLength_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorVARCHAR_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLConnectorVARCHAR_Parms, ReturnValue), Z_Construct_UScriptStruct_FMySQLConnectorTableField, METADATA_PARAMS(nullptr, 0) }; // 843490701
	...
	struct Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics
	{
		...
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_ConnectionTimeout;
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_ReadTimeout;
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_WriteTimeout;
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_Host = { "Host", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, Host), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_UserName = { "UserName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, UserName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_UserPassword = { "UserPassword", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, UserPassword), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_DatabaseName = { "DatabaseName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, DatabaseName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_ConnectionTimeout = { "ConnectionTimeout", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, ConnectionTimeout), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_ReadTimeout = { "ReadTimeout", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, ReadTimeout), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_WriteTimeout = { "WriteTimeout", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, WriteTimeout), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventMySQLInitConnection_Parms, ReturnValue), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_ConnectionTimeout,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_ReadTimeout,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection_Statics::NewProp_WriteTimeout,
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySQLDatabase_TruncateTable_Statics::NewProp_TableName = { "TableName", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventTruncateTable_Parms, TableName), METADATA_PARAMS(Z_Construct_UFunction_UMySQLDatabase_TruncateTable_Statics::NewProp_TableName_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySQLDatabase_TruncateTable_Statics::NewProp_TableName_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySQLDatabase_TruncateTable_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MySQLDatabase_eventTruncateTable_Parms, Connection), Z_Construct_UClass_UMySQLConnection_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMySQLDatabase_TruncateTable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(MySQLDatabase_eventTruncateTable_Parms), &Z_Construct_UFunction_UMySQLDatabase_TruncateTable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMySQLDatabase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMySQLDatabase_CreateTable, "CreateTable" }, // 323453859
		{ &Z_Construct_UFunction_UMySQLDatabase_DropTable, "DropTable" }, // 2893843183
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorExecuteQuery, "MySQLConnectorExecuteQuery" }, // 1815212348
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetData, "MySQLConnectorGetData" }, // 2947448030
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorGetPlayerControllerIP, "MySQLConnectorGetPlayerControllerIP" }, // 1412263941
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorInsertTest, "MySQLConnectorInsertTest" }, // 4071504091
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorINT, "MySQLConnectorINT" }, // 1746717037
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLConnectorVARCHAR, "MySQLConnectorVARCHAR" }, // 3707072724
		{ &Z_Construct_UFunction_UMySQLDatabase_MySQLInitConnection, "MySQLInitConnection" }, // 1435303579
		{ &Z_Construct_UFunction_UMySQLDatabase_TruncateTable, "TruncateTable" }, // 4075606637
	};
#if WITH_METADATA
	...
	template<> MYSQLCONNECT_API UClass* StaticClass<UMySQLDatabase>()
	{
		return UMySQLDatabase::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMySQLDatabase);
	UMySQLDatabase::~UMySQLDatabase() {}
	struct Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics::ScriptStructInfo[] = {
		{ FMySQLConnectorConnectionStruct::StaticStruct, Z_Construct_UScriptStruct_FMySQLConnectorConnectionStruct_Statics::NewStructOps, TEXT("MySQLConnectorConnectionStruct"), &Z_Registration_Info_UScriptStruct_MySQLConnectorConnectionStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMySQLConnectorConnectionStruct), 3437484295U) },
		{ FMySQLConnectorKeyValuePair::StaticStruct, Z_Construct_UScriptStruct_FMySQLConnectorKeyValuePair_Statics::NewStructOps, TEXT("MySQLConnectorKeyValuePair"), &Z_Registration_Info_UScriptStruct_MySQLConnectorKeyValuePair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMySQLConnectorKeyValuePair), 3667479316U) },
		{ FMySQLConnectorQueryResultRow::StaticStruct, Z_Construct_UScriptStruct_FMySQLConnectorQueryResultRow_Statics::NewStructOps, TEXT("MySQLConnectorQueryResultRow"), &Z_Registration_Info_UScriptStruct_MySQLConnectorQueryResultRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMySQLConnectorQueryResultRow), 1138700082U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMySQLDatabase, UMySQLDatabase::StaticClass, TEXT("UMySQLDatabase"), &Z_Registration_Info_UClass_UMySQLDatabase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySQLDatabase), 2420325545U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_322565137(TEXT("/Script/MySqlConnect"),
		Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProgrammingWorks_GenAi_Git_GenAi_Housing_Plugins_MySqlConnect_Source_MySqlConnect_Public_MySQLDatabase_h_Statics::ScriptStructInfo),
		nullptr, 0);
